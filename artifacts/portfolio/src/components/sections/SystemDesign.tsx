        ...
        <div className="py-12 relative">
          <div className="flex flex-col lg:flex-row items-center justify-center gap-4 lg:gap-8 max-w-5xl mx-auto">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              className="flex flex-col items-center p-6 bg-card rounded-2xl border-2 border-border shadow-lg w-48 relative z-10"
            >
            ...
            >
              <div className="h-0.5 w-12 bg-border relative"><ArrowRight className="absolute -right-3 -top-2.5 w-6 h-6" /></div>
            </motion.div>
            <div className="lg:hidden h-8 w-0.5 bg-border my-2 relative"><div className="absolute -bottom-1 -left-1.5 w-3 h-3 border-b-2 border-r-2 border-border transform rotate-45" /></div>
            ...
            <motion.div 
              ...
              className="flex flex-col items-center p-6 bg-card rounded-2xl border-2 border-primary/50 shadow-lg shadow-primary/10 w-48 relative z-10"
            >
            ...
            <div className="hidden lg:flex flex-col justify-center h-48 relative w-20">
               <motion.div initial={{ width: 0 }} whileInView={{ width: "100%" }} viewport={{ once: true }} className="absolute top-1/4 left-0 h-0.5 bg-border w-full"><ArrowRight className="absolute -right-3 -top-2.5 w-6 h-6 text-muted-foreground" /></motion.div>
               <motion.div initial={{ width: 0 }} whileInView={{ width: "100%" }} viewport={{ once: true }} className="absolute bottom-1/4 left-0 h-0.5 bg-border w-full"><ArrowRight className="absolute -right-3 -top-2.5 w-6 h-6 text-muted-foreground" /></motion.div>
            </div>
            
            <div className="lg:hidden flex gap-8 my-2">
              <div className="h-8 w-0.5 bg-border relative"><div className="absolute -bottom-1 -left-1.5 w-3 h-3 border-b-2 border-r-2 border-border transform rotate-45" /></div>
              <div className="h-8 w-0.5 bg-border relative"><div className="absolute -bottom-1 -left-1.5 w-3 h-3 border-b-2 border-r-2 border-border transform rotate-45" /></div>
            </div>
            ...
            <div className="flex lg:flex-col gap-6">
              <motion.div 
                ...
                className="flex flex-col items-center p-6 bg-card rounded-2xl border-2 border-border shadow-lg w-48"
              >
